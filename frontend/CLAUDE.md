...
You are able to use the Svelte MCP server, where you have access to comprehensive
...
structured list with titles, use_cases, and paths.
...
get-documentation tool to fetch ALL documentation sections that are relevant for
the user's task.
